...
class StudentRepository:
    """
    Bertanggung jawab HANYA untuk akses dan penyimpanan data siswa.
    — SOLID SRP: satu kelas, satu tanggung jawab —

    Relasi:
        Komposisi dengan Student (Materi 05):
        StudentRepository "memiliki" daftar Student dan mengelola siklus hidupnya.
    """

    def __init__(self, filepath: str):
        self._filepath: str = filepath
        self._students: List[Student] = []   # private enkapsulasi

    def load_from_csv(self) -> List[Student]:           # membaca CSV nya
        """Muat data siswa dari file CSV. Implementasi File I/O (Materi 14)."""
            ...
            with open(self._filepath, newline='', encoding='utf-8') as f:
                ...
                for i, row in enumerate(reader, start=1):
                    try:
                        ...
                        errors += 1                                         # lewati baris rusak dan catat error
    ...
    def save_to_json(self, output_path: str):                               # Menyimpan ke JSON
